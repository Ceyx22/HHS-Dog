"""Launch Basic View of Unitree-Dog 

   ros2 launch unitree-dog basic.launch.py
...
def generate_launch_description():
    ...
    rvizcfg = os.path.join(pkgdir('unitree-dog'), 'rviz/viewurdf.rviz')

    # Locate the URDF file.
    urdf = os.path.join(pkgdir('unitreedog'), 'urdf/go1.urdf')
